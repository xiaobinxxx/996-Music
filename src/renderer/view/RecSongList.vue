    ...
    <div class="page_table">
        ...
        <div class="song_list">
            <div class="song_title">
                <div class="list" style="width: 50%" :style="`color:${$store.state.ColorSwitch.TxtColor};`">
                    <span>歌曲</span>
                </div>
                <div class="list" style="width: 30%" :style="`color:${$store.state.ColorSwitch.TxtColor};`">
                    <span>歌手</span>
                </div>
                <div class="list" style="width: 20%" :style="`color:${$store.state.ColorSwitch.TxtColor};`">
                    <span>专辑</span>
                </div>
            ...
            <div class="music_list" ref="rew_con" @scroll="scrollPage">
                <div class="list" v-for="(item,index) in SongList" :key="index">
                    <div class="title" :style="`color:${$store.state.ColorSwitch.TxtColor}`">
                        <span>{{item.name}}</span>
                        <span class="quality"
                              :style="`color:${$store.state.ColorSwitch.IconColor};border-color:${$store.state.ColorSwitch.IconColor}`">SQ</span>
